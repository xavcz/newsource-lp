				...
				<div className="container">
					<div className="row">
						<div className="col s12 m7">
							...
							<h5 className="header flow-text primary-text-color">À partir de l'état actuel de ton projet, nous t'apportons des ressources qui poussent à l'action. Plus qu'un outil, c'est une méthode.</h5>
						</div>
