				...
				<div className="container">
					<div className="row">
						<div className="col s12">
							...
							<h5 className="header flow-text primary-text-color">En fonction de ton projet et de son état actuel, NewSource t'apporte des ressources et des informations personnalisées qui te poussent à l'action. Plus qu'un outil, c'est une méthode.</h5>
						</div>
					</div>
					<div className="row">
