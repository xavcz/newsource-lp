...
if (require('./_descriptors')) {
  ...
  var addGetter = function addGetter(it, key, internal) {
    setDesc(it, key, { get: function get() {
  ...
  module.exports = function (KEY, BYTES, wrapper, CLAMPED) {
    ...
    if (FORCED) {
      ...
      TypedArray = wrapper(function (that, data, $offset, $length) {
        ...
        if (data instanceof $ArrayBuffer) return $length !== undefined ? new Base(data, toOffset($offset, BYTES), $length) : $offset !== undefined ? new Base(data, toOffset($offset, BYTES)) : new Base(data);
...
//# sourceMappingURL=_typed-array-compiled.js.map