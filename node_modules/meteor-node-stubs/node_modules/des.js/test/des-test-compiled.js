...
describe('DES', function () {
  ...
  describe('encryption/decryption', function () {
    ...
    it('should buffer during encryption/decryption', function () {
      ...
      var cipher = [];
      for (var i = 0; i < count; i++) cipher = cipher.concat(enc.update(chunk));
      ...
      var out = [];
      for (var i = 0; i < count; i++) out = out.concat(dec.update(cipher.slice(i * 7, (i + 1) * 7)));
...
//# sourceMappingURL=des-test-compiled.js.map