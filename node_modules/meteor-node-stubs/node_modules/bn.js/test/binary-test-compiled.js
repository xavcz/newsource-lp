...
describe('BN.js/Binary', function () {
  ...
  describe('.bincn()', function () {
    it('should increment bit', function () {
      ...
      assert.equal(new BN(2).bincn(63).toString(16), '8000000000000002');
    });
  });
  ...
  describe('.setn()', function () {
    it('should allow single bits to be set', function () {
      ...
      assert.equal(new BN(0).setn(63, true).toString(16), new BN(1).iushln(63).toString(16));
...
//# sourceMappingURL=binary-test-compiled.js.map