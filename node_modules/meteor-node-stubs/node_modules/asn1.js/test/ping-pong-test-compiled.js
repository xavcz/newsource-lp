...
describe('asn1.js ping/pong', function () {
  ...
  describe('composite', function () {
    ...
    test('optionals', function () {
      this.seq().obj(this.key('hello')['enum']({ 0: 'world', 1: 'devs' }), this.key('how').optional().def('are you')['enum']({
        0: 'are you',
        1: 'are we?!'
      }));
    ...
    test('seqof', function () {
      var S = asn1.define('S', function () {
        this.seq().obj(this.key('a').def('b').int({ 0: 'a', 1: 'b' }), this.key('c').def('d').int({ 2: 'c', 3: 'd' }));
      });
      this.seqof(S);
...
//# sourceMappingURL=ping-pong-test-compiled.js.map