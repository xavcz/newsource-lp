...
cmd.version(pkg.version).usage('[options] <files ...>').option('-s, --schema [name]', 'validate schema name (log, request, response, etc ...)').parse(process.argv);
...
cmd.args.map(function (fileName) {
  ...
  }).then(JSON.parse).then(cmd.schema ? validate[cmd.schema] : validate).then(function (data) {
...
//# sourceMappingURL=har-validator-compiled.js.map