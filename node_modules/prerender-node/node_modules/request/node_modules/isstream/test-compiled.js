...
test(false, 'fake stream obj', { pipe: function pipe() {} });(function () {
...
testDuplex(true, 'ReadableStream11.PassThrough', new ReadableStream11.PassThrough());[CoreStreams, ReadableStream10, ReadableStream11].forEach(function (p) {
