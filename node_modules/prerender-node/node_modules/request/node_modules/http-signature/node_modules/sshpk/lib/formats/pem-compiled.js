...
function read(buf, forceType) {
	...
	if (alg && alg.toLowerCase() === 'openssh') return sshpriv.readSSHPrivate(type, buf);
	if (alg && alg.toLowerCase() === 'ssh2') return rfc4253.readType(type, buf);
...
//# sourceMappingURL=pem-compiled.js.map