...
function DiffieHellman(key) {
	...
	if (key.type === 'dsa') {
		...
		if (!CRYPTO_HAVE_ECDH) {
			if (ecdh === undefined) ecdh = require('ecc-jsbn');
			if (ec === undefined) ec = require('ecc-jsbn/lib/ec');
			if (jsbn === undefined) jsbn = require('jsbn').BigInteger;
		...
		if (ed === undefined) ed = require('jodid25519');
...
//# sourceMappingURL=dhe-compiled.js.map