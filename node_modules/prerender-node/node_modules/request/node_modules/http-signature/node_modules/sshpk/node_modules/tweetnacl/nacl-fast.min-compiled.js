...
!(function (r) {
  "use strict";function t(r, t, n, e) {
    ...
    var i,
        h = 0;for (i = 0; o > i; i++) h |= r[t + i] ^ n[e + i];return (1 & h - 1 >>> 8) - 1;
  }function e(r, t, e, o) {
    return n(r, t, e, o, 16);
  }function o(r, t, e, o) {
    return n(r, t, e, o, 32);
    ...
    var f,
        s,
        u = new Uint8Array(16),
        c = new Uint8Array(64);for (s = 0; 16 > s; s++) u[s] = 0;for (s = 0; 8 > s; s++) u[s] = i[s];for (; o >= 64;) {
    ...
    var i,
        h,
        f = new Uint8Array(16),
        s = new Uint8Array(64);for (h = 0; 16 > h; h++) f[h] = 0;for (h = 0; 8 > h; h++) f[h] = e[h];for (; n >= 64;) {
    ...
    var i = new Uint8Array(32);f(i, e, o, cr);for (var h = new Uint8Array(8), a = 0; 8 > a; a++) h[a] = e[a + 16];return u(r, t, n, h, i);
  }function y(r, t, n, e, o, i, h) {
    var a = new Uint8Array(32);f(a, i, h, cr);for (var u = new Uint8Array(8), c = 0; 8 > c; c++) u[c] = i[c + 16];return s(r, t, n, e, o, u, a);
  }function l(r, t, n, e, o, i) {
    var h = new yr(i);return h.update(n, e, o), h.finish(r, t), 0;
  }function w(r, t, n, o, i, h) {
    var a = new Uint8Array(16);return l(a, 0, n, o, i, h), e(r, t, a, 0);
  }function p(r, t, n, e, o) {
    var i;if (32 > n) return -1;for (y(r, 0, t, 0, n, e, o), l(r, 16, r, 32, n - 32, r), i = 0; 16 > i; i++) r[i] = 0;return 0;
  }function v(r, t, n, e, o) {
    var i,
        h = new Uint8Array(32);if (32 > n) return -1;if ((c(h, 0, 32, e, o), 0 !== w(t, 16, t, 32, n - 32, h))) return -1;for (y(r, 0, t, 0, n, e, o), i = 0; 32 > i; i++) r[i] = 0;return 0;
  }function b(r, t) {
    var n;for (n = 0; 16 > n; n++) r[n] = 0 | t[n];
  }function g(r) {
    var t,
        n,
        e = 1;for (t = 0; 16 > t; t++) n = r[t] + e + 65535, e = Math.floor(n / 65536), r[t] = n - 65536 * e;r[0] += e - 1 + 37 * (e - 1);
  }function _(r, t, n) {
    ...
    var n,
        ...
        o,
        i = $(),
        h = $();for (n = 0; 16 > n; n++) h[n] = t[n];for (g(h), g(h), g(h), e = 0; 2 > e; e++) {
    ...
    var n = new Uint8Array(32),
        e = new Uint8Array(32);return A(n, r), A(e, t), o(n, 0, e, 0);
  }function U(r) {
    var t = new Uint8Array(32);return A(t, r), 1 & t[0];
  }function E(r, t) {
    var n;for (n = 0; 16 > n; n++) r[n] = t[2 * n] + (t[2 * n + 1] << 8);r[15] &= 32767;
  }function x(r, t, n) {
    for (var e = 0; 16 > e; e++) r[e] = t[e] + n[e];
  }function M(r, t, n) {
    for (var e = 0; 16 > e; e++) r[e] = t[e] - n[e];
  }function m(r, t, n) {
    var e,
    ...
    var e,
        ...
        u = $(),
        c = $(),
        y = $();for (o = 0; 31 > o; o++) i[o] = t[o];for (i[31] = 127 & t[31] | 64, i[0] &= 248, E(h, n), o = 0; 16 > o; o++) f[o] = h[o], u[o] = a[o] = s[o] = 0;for (a[0] = u[0] = 1, o = 254; o >= 0; --o) e = i[o >>> 3] >>> (7 & o) & 1, _(a, f, e), _(s, u, e), x(c, a, s), M(a, a, s), x(s, f, u), M(f, f, u), B(u, c), B(y, a), m(a, s, a), m(s, f, c), x(c, a, s), M(a, a, s), B(f, a), M(s, u, y), m(a, s, ir), x(a, a, u), m(s, s, a), m(a, u, y), m(u, f, h), B(f, c), _(a, f, e), _(s, u, e);for (o = 0; 16 > o; o++) h[o + 16] = a[o], h[o + 32] = s[o], h[o + 48] = f[o], h[o + 64] = u[o];var l = h.subarray(32),
        w = h.subarray(16);return S(l, l), m(w, w, l), A(r, w), 0;
  }function Y(r, t) {
    return T(r, t, nr);
  }function k(r, t) {
    return rr(t, 32), Y(r, t);
  }function L(r, t, n) {
    var e = new Uint8Array(32);return T(e, n, t), f(r, tr, e, cr);
  }function z(r, t, n, e, o, i) {
    var h = new Uint8Array(32);return L(h, o, i), lr(r, t, n, e, h);
  }function R(r, t, n, e, o, i) {
    var h = new Uint8Array(32);return L(h, o, i), wr(r, t, n, e, h);
  }function P(r, t, n, e) {
    ...
    var o,
        ...
        f = e;for (i[0] = 1779033703, i[1] = 3144134277, i[2] = 1013904242, i[3] = 2773480762, i[4] = 1359893119, i[5] = 2600822924, i[6] = 528734635, i[7] = 1541459225, h[0] = 4089235720, h[1] = 2227873595, h[2] = 4271175723, h[3] = 1595750129, h[4] = 2917565137, h[5] = 725511199, h[6] = 4215389547, h[7] = 327033209, P(i, h, n, e), e %= 128, o = 0; e > o; o++) a[o] = n[f - e + o];for (a[e] = 128, e = 256 - 128 * (112 > e ? 1 : 0), a[e - 9] = 0, t(a, e - 8, f / 536870912 | 0, f << 3), P(i, h, a, e), o = 0; 8 > o; o++) t(r, 8 * o, i[o], h[o]);return 0;
  }function N(r, t) {
    var n = $(),
        e = $(),
        o = $(),
        ...
        f = $(),
        s = $(),
        u = $();M(n, r[1], r[0]), M(u, t[1], t[0]), m(n, n, u), x(e, r[0], r[1]), x(u, t[0], t[1]), m(e, e, u), m(o, r[3], t[3]), m(o, o, ar), m(i, r[2], t[2]), x(i, i, i), M(h, e, n), M(a, i, o), x(f, i, o), x(s, e, n), m(r[0], h, a), m(r[1], s, f), m(r[2], f, a), m(r[3], h, s);
  }function C(r, t, n) {
    var e;for (e = 0; 4 > e; e++) _(r[e], t[e], n);
  }function F(r, t) {
    var n = $(),
        e = $(),
        o = $();S(o, t[2]), m(n, t[0], o), m(e, t[1], o), A(r, e), r[31] ^= U(n) << 7;
  }function I(r, t, n) {
    var e, o;for (b(r[0], er), b(r[1], or), b(r[2], or), b(r[3], er), o = 255; o >= 0; --o) e = n[o / 8 | 0] >> (7 & o) & 1, C(r, t, e), N(t, r), N(r, r), C(r, t, e);
  }function G(r, t) {
    var n = [$(), $(), $(), $()];b(n[0], fr), b(n[1], sr), b(n[2], or), m(n[3], fr, sr), I(r, n, t);
  }function Z(r, t, n) {
    var e,
        o = new Uint8Array(64),
        i = [$(), $(), $(), $()];for (n || rr(t, 32), O(o, t, 32), o[0] &= 248, o[31] &= 127, o[31] |= 64, G(i, o), F(r, i), e = 0; 32 > e; e++) t[e + 32] = r[e];return 0;
  }function j(r, t) {
    var n, e, o, i;for (e = 63; e >= 32; --e) {
    ...
    var t,
        n = new Float64Array(64);for (t = 0; 64 > t; t++) n[t] = r[t];for (t = 0; 64 > t; t++) r[t] = 0;j(r, n);
  }function V(r, t, n, e) {
    var o,
        i,
        h = new Uint8Array(64),
        ...
        u = [$(), $(), $(), $()];O(h, e, 32), h[0] &= 248, h[31] &= 127, h[31] |= 64;var c = n + 64;for (o = 0; n > o; o++) r[64 + o] = t[o];for (o = 0; 32 > o; o++) r[32 + o] = h[32 + o];for (O(f, r.subarray(32), n + 32), q(f), G(u, f), F(r, u), o = 32; 64 > o; o++) r[o] = e[o];for (O(a, r, n + 64), q(a), o = 0; 64 > o; o++) s[o] = 0;for (o = 0; 32 > o; o++) s[o] = f[o];for (o = 0; 32 > o; o++) for (i = 0; 32 > i; i++) s[o + i] += a[o] * h[i];return j(r.subarray(32), s), c;
  }function X(r, t) {
    var n = $(),
        e = $(),
        o = $(),
        ...
        h = $(),
        a = $(),
        f = $();return b(r[2], or), E(r[1], t), B(o, r[1]), m(i, o, hr), M(o, o, r[2]), x(i, r[2], i), B(h, i), B(a, h), m(f, a, h), m(n, f, o), m(n, n, i), K(n, n), m(n, n, o), m(n, n, i), m(n, n, i), m(r[0], n, i), B(e, r[0]), m(e, e, i), d(e, o) && m(r[0], r[0], ur), B(e, r[0]), m(e, e, i), d(e, o) ? -1 : (U(r[0]) === t[31] >> 7 && M(r[0], er, r[0]), m(r[3], r[0], r[1]), 0);
  }function D(r, t, n, e) {
    var i,
        h,
        a = new Uint8Array(32),
        f = new Uint8Array(64),
        s = [$(), $(), $(), $()],
        u = [$(), $(), $(), $()];if ((h = -1, 64 > n)) return -1;if (X(u, e)) return -1;for (i = 0; n > i; i++) r[i] = t[i];for (i = 0; 32 > i; i++) r[i + 32] = e[i];if ((O(f, r, n), q(f), I(s, u, f), G(u, t.subarray(32)), N(s, u), F(a, s), n -= 64, o(t, 0, a, 0))) {
    ...
    var r, t;for (t = 0; t < arguments.length; t++) if ("[object Uint8Array]" !== (r = Object.prototype.toString.call(arguments[t]))) throw new TypeError("unexpected type " + r + ", use Uint8Array");
  }function W(r) {
    for (var t = 0; t < r.length; t++) r[t] = 0;
  }var $ = function $(r) {
    var t,
        n = new Float64Array(16);if (r) for (t = 0; t < r.length; t++) n[t] = r[t];return n;
  },
      rr = function rr() {
    throw new Error("no PRNG");
  },
      tr = new Uint8Array(16),
      nr = new Uint8Array(32);nr[0] = 9;var er = $(),
      or = $([1]),
      ir = $([56129, 1]),
    ...
    var n,
        ...
        o,
        i,
        h = new Uint16Array(10);if (this.leftover) {
    ...
    if ((Q(r, t), r.length !== Ur)) throw new Error("bad n size");if (t.length !== dr) throw new Error("bad p size");var n = new Uint8Array(dr);return T(n, r, t), n;
  }, r.scalarMult.base = function (r) {
    if ((Q(r), r.length !== Ur)) throw new Error("bad n size");var t = new Uint8Array(dr);return Y(t, r), t;
  }, r.scalarMult.scalarLength = Ur, r.scalarMult.groupElementLength = dr, r.box = function (t, n, e, o) {
    var i = r.box.before(e, o);return r.secretbox(t, n, i);
  }, r.box.before = function (r, t) {
    Q(r, t), J(r, t);var n = new Uint8Array(Mr);return L(n, r, t), n;
  }, r.box.after = r.secretbox, r.box.open = function (t, n, e, o) {
    var i = r.box.before(e, o);return r.secretbox.open(t, n, i);
  }, r.box.open.after = r.secretbox.open, r.box.keyPair = function () {
    var r = new Uint8Array(Er),
        t = new Uint8Array(xr);return k(r, t), { publicKey: r, secretKey: t };
  }, r.box.keyPair.fromSecretKey = function (r) {
    if ((Q(r), r.length !== xr)) throw new Error("bad secret key size");var t = new Uint8Array(Er);return Y(t, r), { publicKey: t, secretKey: new Uint8Array(r) };
    ...
    if ((Q(r, t), t.length !== Yr)) throw new Error("bad secret key size");var n = new Uint8Array(Kr + r.length);return V(n, r, r.length, t), n;
  }, r.sign.open = function (r, t) {
    if (2 !== arguments.length) throw new Error("nacl.sign.open accepts 2 arguments; did you mean to use nacl.sign.detached.verify?");if ((Q(r, t), t.length !== Tr)) throw new Error("bad public key size");var n = new Uint8Array(r.length),
        e = D(n, r, r.length, t);if (0 > e) return null;for (var o = new Uint8Array(e), i = 0; i < o.length; i++) o[i] = n[i];return o;
    ...
    if ((Q(r, t, n), t.length !== Kr)) throw new Error("bad signature size");if (n.length !== Tr) throw new Error("bad public key size");var e,
        o = new Uint8Array(Kr + r.length),
        i = new Uint8Array(Kr + r.length);for (e = 0; Kr > e; e++) o[e] = t[e];for (e = 0; e < r.length; e++) o[e + Kr] = r[e];return D(i, o, o.length, n) >= 0;
  }, r.sign.keyPair = function () {
    var r = new Uint8Array(Tr),
        t = new Uint8Array(Yr);return Z(r, t), { publicKey: r, secretKey: t };
    ...
    Q(r);var t = new Uint8Array(Lr);return O(t, r, r.length), t;
    ...
    var t = "undefined" != typeof self ? self.crypto || self.msCrypto : null;if (t && t.getRandomValues) {
      var n = 65536;r.setPRNG(function (r, e) {
        var o,
            i = new Uint8Array(e);for (o = 0; e > o; o += n) t.getRandomValues(i.subarray(o, o + Math.min(e - o, n)));for (o = 0; e > o; o++) r[o] = i[o];W(i);
      });
    } else "undefined" != typeof require && (t = require("crypto"), t && t.randomBytes && r.setPRNG(function (r, n) {
      var e,
          o = t.randomBytes(n);for (e = 0; n > e; e++) r[e] = o[e];W(o);
    }));
  })();
})("undefined" != typeof module && module.exports ? module.exports : self.nacl = self.nacl || {});

//# sourceMappingURL=nacl-fast.min-compiled.js.map